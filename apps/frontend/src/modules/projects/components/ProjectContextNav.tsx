...
export type ProjectSection = "overview" | "team";
...
const SECTIONS: readonly { readonly id: ProjectSection; readonly label: string }[] = [
 ...
 */
export function ProjectContextNav({ projectId, active }: ProjectContextNavProps) {
  return (
    <nav aria-label="Project sections" className={styles.scopeNav}>
      {SECTIONS.map((section) => {
        const isActive = section.id === active;
        const href =
          section.id === "overview" ? `/projects/${projectId}` : `/projects/${projectId}/team`;
